...
/**
 * Classe de logs de dentro dos processos e m�dulo
 * @package Workflow
...
{
	/**
	 * @var object $db Objeto de banco de dados j� conectado
	 * @access private
	 */
	private $db = null;
	...
	/**
	 * @var string $logPath Caminho onde ser� salvo o arquivo de log, caso o tipo de log Log_file seja adicionado � composi��o
	 * @access private
	 */
	private $logPath = null;

	/**
	 * @var string $logFileName Nome do arquivo de log, caso o tipo de log Log_file seja adicionado � composi��o
	 * @access private
	 */
	...
	/**
	 * @var array $logTypes Array com ponteiros para os objetos de log adicionados � composi��o
	 * @access private
	 */
	...
	/**
	 * @var int $logLevel n�vel de log atualmente configurado
	 * @access protected
	 */
	 ...
	 * @param string $curProcessName nome normalizado do processo que utilizar� o log
	 ...
	 * @return object Objeto da classe Log_($logType) ou null caso o tipo de log n�o exista ou n�o seja permitido no frontend
	 * @access private
	 */
	...
	/**
	 * Adiciona um tipo de log � composi��o de logs caso ela j� n�o tenha sido adicionada
	 * @params string $logType tipo de log a ser adicionado
	 * @return boolean true no caso do tipo de log ter sido adicionado com sucesso, false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Remove um tipo de log da composi��o de logs
	 * @params $logType tipo de log a ser removido
	 * @return object Objeto Log_($logType) removido, ou null caso n�o tenha removido qualquer um
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel emerg�ncia (sistema inoperante)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel alerta (a��o imediata requerida)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel cr�tico (situa��es cr�ticas)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel erro (situa��es de erro)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel aviso (condi��es de aviso - warning)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel notifica��o (situa��es normais, mas significantes)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
	...
	/**
	 * Grava um log do n�vel informa��o (informacional)
	 * @params string $message Mensagem a ser gravada do log
	 * @return boolean true em caso de sucesso e false caso contr�rio
	 * @access public
	 */
