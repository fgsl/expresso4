...
{
	/**
	 * @var int $weekDays Inteiro que representa os dias da semana quando o Job ser� executado
	 * @access private
	 */
	private $weekDays;
	...
	/**
	 * Pega o inteiro que representa os dias da semana quando o Job ser� executado
	...
	/**
	 * Define o inteiro que representa os dias da semana quando o Job ser� executado
	 * @param int $weekDays Inteiro que representa os dias da semana
	 * @return void
	 * @access public
	 */
