...
/**
 * Implementa métodos para administra��o do controle de acesso ao workflow.
...
{
	/**
	* @var object $so Objeto para acesso � camada de dados
	* @access public
	*/
	var $so;
	...
	*/
	function bo_adminaccess()
	{
		...
		if (!Factory::getInstance('workflow_acl')->checkWorkflowAdmin($_SESSION['phpgw_info']['workflow']['account_id']))
			exit(serialize(array('error' => 'Voc� n�o tem permiss�o para executar esta opera��o.')));

		$this->so = &Factory::getInstance('so_adminaccess', Factory::getInstance('WorkflowObjects')->getDBGalaxia()->Link_ID);
	}

	/**
	* Obt�m a lista de processos (consulta ao engine)
	*
	...
	*/
	...
	/**
	* Obt�m a lista de administradores de um organograma
	*
	...
	*/
	...
	/**
	* Obt�m a lista de administradores de um processo
	*
	* @param array $p processo
	...
	*/
	function set_organogram_admin_level($p)
	{
		...
		if (!$result) {
			return "N�o atualizou as permiss�es.";
		}
		
	}

	/**
	* Busca os usu�rios/grupos que possuem acesso a uma determinada aplica��o externa
	*
	* @param array $params Lista de par�metros vindas do Ajax
	...
	*/
	...
	/**
	* Remove o acesso de um usu�rio/grupo a uma aplica��o externa
	*
	* @param array $params Lista de par�metros vindas do Ajax
	...
	*/
	...
	/**
	* D� acesso para um usu�rio/grupo a uma aplica��o externa
	*
	* @param array $params Lista de par�metros vindas do Ajax
	* @return array lista de administradores de uma aplicacao externa
	* @access public
	*/
	...
	/**
	* Busca os usu�rios/grupos que podem administrar o m�dulo Workflow
	*
	* @param array $params Lista de par�metros advindos do Ajax
	* @return array Lista dos usu�rios com direito de administrar o m�dulo Workflow
	* @access public
	*/
	...
	/**
	* D� privil�gio de administrar o m�dulo Workflow para um usu�rio/grupo
	*
	* @param array $params Lista de par�metros advindos do Ajax
	* @return array Lista dos usu�rios com direito de administrar o m�dulo Workflow
	* @access public
	*/
	...
	/**
	* Remove o privil�gio de administrar o m�dulo Workflow de um usu�rio/grupo
	*
	* @param array $params Lista de par�metros advindos do Ajax
	* @return array Lista dos usu�rios com direito de administrar o m�dulo Workflow
	* @access public
	*/
	...
	/**
	* Busca os usu�rios/grupos que podem criar/administrar processos de Workflow
	*
	* @param array $params Lista de par�metros vindas do Ajax
	...
	*/
	...
	/**
	* D� privil�gio de criar/administrar processos de Workflow para um usu�rio/grupo
	*
	* @param array $params Lista de par�metros vindas do Ajax
	* @return array lista dos usuarios com direito de criar/administrar processos
	* @access public
	*/
	...
	/**
	* Remove o privil�gio de criar/administrar processos de Workflow de um usu�rio/grupo
	*
	* @param array $params Lista de par�metros vindas do Ajax
	* @return array Lista dos usuarios com direito de criar/administrar processos
	* @access public
	...
	*/
	...
	/**
	* Verifica se o usu�rio tem direito de acesso a um recurso
	*
	* @param string $type tipo de recurso
	* @param integer $uid id do usu�rio
	...
	*/
	...
	/**
	* Retorna as permissoes do us�ario
	*
	...
	*/
	...
	/**
	* Informa o n�vel de administra��o do usu�rio
	* @param string $type O tipo do recurso
	* @param int $uid O ID do usu�rio
	* @param int $numvalue O ID do recurso
	* @return array As permiss�es do usu�rio (em forma de n�mero e de bits)
	* @access public
	*/
	...
	/**
	* Informa o n�vel de administra��o do usu�rio (incluindo heran�a por grupo)
	* @param string $type O tipo do recurso
	* @param int $uid O ID do usu�rio
	* @param int $numvalue O ID do recurso
	* @return array As permiss�es do usu�rio, inclusive heran�a por grupo. As permiss�es s�o retornadas em forma de n�mero e de bits
	* @access public
	*/
