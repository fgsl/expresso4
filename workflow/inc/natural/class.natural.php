...
/**
 * Código ascii do caracter espa�o
 * @name SPACE
 */
define (SPACE, ' ');
 ...
 *
 * @author Everton Fl�vio Rufino Se�ra - rufino@celepar.pr.gov.br
 * @version 1.0
 * @package Workflow
 * @subpackage natural
...
class Natural
{
	...
	private $acronym;
	/**
	 * @var boolean $isDBGateway Flag utilizado para determinar se ser� utilizado o protocolo DBGateway ou DBCON
	 * @access private
	 */
	private $isDBGateway;
	/**
	 * @var int $numRows N�mero de linhas
	 * @access private
	 */
	private $numRows;
	/**
	 * @var string $IPAddress Endere�o IP do Mainframe e.g:"10.15.60.20"
	 * @access private
	 */
	private $IPAddress;
	/**
	...
	private $logon;
	/**
	 * @var string $rc  PA_RC - C�digo de Retorno (4 bytes)
	 * @access private
	 */
	private $rc;
	/**
	...
	/**
	 * @var object $obj Objeto de Classe que cont�m a especifica��o e estrutura do programa natural acessado
	 * @access protected
	 */
	protected $obj;
...
//		$this->strInputParameter = strtoupper($strInputParameter);
	 ...
	 * @param int $system 4 d�gitos em caixa alta
	 * @access protected
	 * @return void
	 */
	...
	/**
	 * Seta o c�digo de retorno
	 * @param int $rc c�digo de retorno com 4 d�gitos
	 * @access protected
	 * @return void
	 */
