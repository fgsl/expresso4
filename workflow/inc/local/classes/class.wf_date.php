<?php
/**
 * Corresponde ao formato de data armazenado na configura��o (d/m/Y ou Y/m/d)
...
/**
 * Classe para manipula��o e realiza��o de c�lculos com datas
 * @author Marcos Pont
...
class wf_date
{
	...
	/**
	 * Verifica se uma determinada data � v�lida
	 * @access public
	...
	/**
	 *	Verifica se um valor de time zone � v�lido
	 *	@access public
	...
	/**
	 * Verifica se uma data est� no formato europeu dd[/-.]mm[/-.]YYYY[ HH:mm:ss]
	 * @param array &$regs Vetor para onde retornam os valores destacados de dia, m�s e ano
	 * @access public
	 * @return boolean
	 */
	...
	/**
	 * Verifica se uma data est� no formato americano YYYY[/-.]mm[/-.]dd[ HH:mm:ss]
	...
	/**
	 * Verifica se uma data est� no formato SQL YYYY-mm-dd
	 * @param string $date Data a ser verificada
	 * @param array &$regs Vetor para onde retornam os valores destacados de dia, m�s e ano
	 * @access public
	 * @return boolean
	...
	/**
	 * Verifica se uma data � posterior � data atual
	 * @access public
	 * @param string $date Data a ser verificada
	 * @return boolean
	 */
	...
	/**
	 * Verifica se uma data � anterior � data atual
	 * @access public
	 * @param string date Data a ser verificada
	 * @return boolean
	 */
	...
	/**
	 * Calcula o dia seguinte em rela��o � data atual
	 * @access public
	...
	/**
	 * Verifica se um determinado valor � NULL
	...
	function pastDate($date, $days=0, $months=0, $years=0) {
		...
		// Calcula o n�mero de dias da data original
		$daysFrom = $this->dateToDays($date);
		$daysDec = 0;
		// Adiciona os anos
		for ($i = 1; $i <= $years; ++$i) {
		...
		// Adiciona os meses de acordo com os dias de cada m�s
		for ($i = 1; $i <= $months; ++$i) {
			$mTemp = $i % 12;
			$yTemp = intval($i / 12);
			if (($month - $mTemp) <= 0) {
	...
	function getDiff($dateM, $dateS, $unsigned=TRUE) {
		// Calcula o n�mero de dias da diferen�a
	 ...
	 * @return mixed Nome ou n�mero do dia da semana (baseado em zero)
	 * @access public 
	 */
	function dayOfWeek($date, $text=TRUE, $abbr=FALSE) {
		...
		// Exibi��o do resultado, de acordo com os par�metros fornecidos
		if ($text) {
			$daysOfWeek = array('segunda', 'ter�a', 'quarta', 'quinta', 'sexta');
			if ($abbr) {
	...
	/**
	 * Retorna o n�mero de dias de um m�s de acordo com o m�s e o ano
	 * @param int $month M�s
	 * @param int $year Ano
	 * @return int N�mero de dias do m�s solicitado
	 * @access public 
	 */
	...
	/**
	 * Converte uma data no padr�o europeu (dd/mm/YYYY) para o padr�o SQL (YYYY-mm-dd)
	 * @param string $date Data a ser convertida
	 * @param boolean @preserveTime Preservar por��o de hora, se ela existir na data fornecida
	 * @return string Data convertida ou a original se o padr�o de entrada estiver incorreto
	 * @access public
	 */
	...
	/**
	 * Converte uma data no padr�o europeu (dd/mm/YYYY)
	 * @param string $date Data a ser convertida
	 * @param boolean $preserveTime Preservar por��o de hora, se ela existir na data fornecida
	 * @return string Data convertida ou a original se o padr�o de entrada estiver incorreto
	 * @access public
	...
	/**
	 * Converte uma data no padr� americano (YYYY/mm/dd) para o padr�o SQL (YYYY-mm-dd)
	 * @param string $date Data a ser convertida
	 * @return string Data convertida ou a original se o padr�o de entrada estiver incorreto
	 * @access public
	 */
	...
	/**
	 * Converte uma data no padr�o americano (YYYY/mm/dd) para o padr�o europeu (dd/mm/YYYY)
	 * @param string $date Data a ser convertida
	 * @param boolean $preserveTime Preservar por��o de hora, se ela existir na data fornecida
	 * @return string Data convertida ou a original se o padr�o de entrada estiver incorreto
	 * @access public
	...
	/**
	 * Converte uma data no padr�o SQL (YYYY-mm-dd) para o padr�o europeu (dd/mm/YYYY)
	 * @param string $date	Data a ser convertida
	 * @param boolean preserveTime Preservar por��o de hora, se ela existir na data fornecida
	 * @return string Data convertida ou a original se o padr�o de entrada estiver incorreto
	 * @access public
	...
	/**
	 * Converte uma data no padr�o SQL (YYYY-mm-dd) para o padr�o americano (YYYY/mm/dd)
	 * @param string $date Data a ser convertida
	 * @return string Data convertida ou a original se o padr�o de entrada estiver incorreto
	 * @access public
	 */
	 ...
	 * @param int $unixTimestamp Timestamp UNIX para a convers�o
	...
	/**
	 * Converte uma data para o correspondente em n�mero de dias
	 * @param string $date Data base para o c�lculo
	 * @return int Data convertida em n�mero de dias
	 * @access public
	 */
	...
	/**
	 * Converte um n�mero de dias em uma data
	 ...
	 * @access public
	 * @param int $ts Timestamp opcional para gera��o da data local
	...
	/**
	 * Formata um valor de data a partir dos valores de dia, m�s e ano
	 * @param int $day Valor do dia na data
	 * @param int $month Valor do m�s na data
	 * @param int $year Valor do ano na data, com 4 d�gitos
	 ...
	 * @param string $fmtString Descri��o do formato (quando $fmtType==DATE_FORMAT_CUSTOM)
