...
if ($acao == "excluir_indicador") {
    ...
    pg_query($conn,$sql);
    $msg = "Parâmetro Exclu�do com sucesso!";
}
...
if(isset($lstoid{0})){
    ...
    $form->adicionarCampo("lsiidindicador","lsiidindicador","ID do Indicador:","Identificador do Indicador",$lsiidindicador,true,"20","","Identificador do Indicador. (N�o usar {}).");
    ...
    $form->adicionarCampo("lsilegenda","lsilegenda","Legenda:","Legenda",$lsilegenda,false,"30","","(Deixe em branco para n�o exibir)");
    $form->adicionarCampo("lsilegenda_csv","lsilegenda_csv","Legenda CSV:","Legenda",$lsilegenda_csv,false,"30","","Legenda que ser� exibida no arquivo CSV.");
    $form->adicionarCampo("lsicondicao","lsicondicao","Condi��o de Exibi��o:","Condi��o",$lsicondicao,false,"50","","Condi��o para exibir o indicador. Ex: (({meustatus} == 1) && ({tipo} > 200))");
    ...
    $listagem->adicionarColuna("lsicondicao","Condi��o de Exibi��o","{lsicondicao}","text","left","200px");
