...
foreach ($resposta->listagem as $listagem) {
        ...
        $tr .= "<table class='tableMoldura'>
                <tr class='tableSubTitulo'><td colspan=3><h2>M�dulos dependentes desta listagem em producao.</h2></td></tr>
                <tr class='tableTituloColunas'><td><h3>Arquivo</h3></td><td align='center'><h3>Data Primeiro Acesso</h3></td><td align='center'><h3>Data �ltimo Acesso</h3></td></tr>";
        ...
        if ($versao_desenvolvimento == "0") {
            $versao_desenvolvimento = "N�O EXISTE.";
        } 
        
        if ($versao_producao == "0") {
        	$versao_producao = "N�O EXISTE.";
        } 
...
$html = "<center>
            <table class='tableMoldura'>
               <tr class='tableSubTitulo'><td><h2>Sincroniza��o de Servidores</h2></td></tr>
               <tr><td align='center'>
                ...
                <div style='margin: 10px; width: 300px; border: 1px solid #E0E0E0; float: left;'>
                    ...
                    <br>
                    <br>
                    <h2>VERS�O:<span id='versao_desenvolvimento'>$versao_desenvolvimento</span></h2> 
                ...
                <div style='margin: 10px; width: 300px; border: 1px solid #E0E0E0; float: left;'>
                    ...
                    <br>
                    <br>
                    <h2>VERS�O:<span id='versao_producao'>$versao_producao</span></h2> 
                    <div style='clear: both;'></div>
                </div>
                <div style='clear: both;'></div>
</div>
