...
class SqlParser {
    ...
    var $_bloqueios = array(
        ...
        "update",
        "delete",
        //" into [temp]", //DESSA FORMA A EXPRESS�O INTO � BLOQUEADA MAS SE FOR ACOMPANHADA DA PALAVRA TEMP ENT�O SER� LIBERADA.
        "drop ",
        "alter ",
        "database",
        "create ",
    ...
    function verificaSql() {
        ...
        try {
            ...
            foreach ($this->_bloqueios as $palavra) {
            	...
            	$this->procuraPalavra($select,$palavra,"Por quest�es de seguran�a, a palavra: '" . trim(strtoupper($palavrabloqueada)) . "' n�o � permitida.");
            }
            ...
            if ($condeval != "") {
              ...
              //  echo $fcondicao . "<br>";
                ...
                if ($this->verificaSintaxe($fcondicao) === false) {
                    throw new \Exception("Imposs�vel validar condi��o: ( $condeval )");
                }
