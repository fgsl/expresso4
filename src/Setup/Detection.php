...
final class Detection
{
    ...
    function check_header()
    {
        ...
        else
        {
            ...
            elseif(!GlobalService::isset('phpgw_domain'))
            {
    ...
    function check_lang($check = True)
    {
        ...
        if (!$check)
        {
            GlobalService::set('setup_info', GlobalService::get('phpgw_setup')->detection->get_db_versions(GlobalService::get('setup_info')));
        }
