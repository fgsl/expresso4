...
class CommonFunctions
{
    ...
    {
        if (! isset(GlobalService::get('phpgw_info')['flags']['included_classes'][$included_class]) || ! GlobalService::get('phpgw_info')['flags']['included_classes'][$included_class]) {
     ...
     */
    function CreateObject($class, $p1 = '_UNDEF_', $p2 = '_UNDEF_', $p3 = '_UNDEF_', $p4 = '_UNDEF_', $p5 = '_UNDEF_', $p6 = '_UNDEF_', $p7 = '_UNDEF_', $p8 = '_UNDEF_', $p9 = '_UNDEF_', $p10 = '_UNDEF_', $p11 = '_UNDEF_', $p12 = '_UNDEF_', $p13 = '_UNDEF_', $p14 = '_UNDEF_', $p15 = '_UNDEF_', $p16 = '_UNDEF_')
    {
    ...
    function utf8_encode_recursive($value)
    {
        ...
        if (is_array($value))
            return array_combine(array_map('utf8_encode_recursive', array_keys($value)), array_map('utf8_encode_recursive', $value));
        return $value;
    }
