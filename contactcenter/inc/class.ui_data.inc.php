		...
		*/
		...
		function get_qtds_compartilhado() {
        	...
        	foreach($relacionados as $uid_relacionado => $tipo_relacionamento) {
            	...
            	$aclTemp->read();
                $perms_relacao[$uid_relacionado] = $aclTemp->get_specific_rights(GlobalService::get('phpgw_info')['user']['account_id'],'contactcenter'); //Preciso verificar as permiss�es que o contato relacionado deu para o atual
			}
