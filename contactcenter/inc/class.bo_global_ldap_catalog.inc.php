...
*/					case 'LIKE':
		...
		*/
		function get_single_entry ( $id_contact, $fields, $external=false )
		{
			...
			//Altera��o feita especificamente para tratar problema da montagem do $id_contact
			if(!$external)
			{
		...
		function generate_filter($id_contacts)
		{
			if (($size = count($id_contacts)))
			{
				...
				for ($i = 0; $i < $size; $i++)
				{
					...
					// 
					//  N�o utiliza mais a fun��o ldap_explode, usa a express�o regular a seguir para pegar o primeiro
					//  componente da dn
					// 
    				...
    				// posteriormente poder� ser necess�rio substituir por uma express�o regular mais gen�rica.
    				//
					...
					if ($cn[1])
					{
						...
						// pela fun��o ldap_explode_dn(). Talvez seja necess�rio utilizar esta tradu��o em outros lugares,
						// neste caso � mais apropriado colocar dentro de uma fun��o.
						//
