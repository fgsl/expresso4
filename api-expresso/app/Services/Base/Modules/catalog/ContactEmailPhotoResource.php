...
class ContactEmailPhotoResource extends CatalogAdapter {
	...
	public function setDocumentation() {
		$this->setResource("Catalog","Catalog/Photo","Retorna a Foto do Usu�rio.",array("GET"));
		$this->setIsMobile(true);
		$this->addResourceParam("auth","string",true,"Chave de autentica��o do Usu�rio.",false);
		$this->addResourceParam("email","string",false,"Email do usu�rio que ser� buscado a foto.");
	}
