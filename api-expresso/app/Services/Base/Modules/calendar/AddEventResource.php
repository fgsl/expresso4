...
class AddEventResource extends CalendarAdapter {
	...
	public function post( $request ){
		...
		//USADO PARA for�ar A inclus�o DE UM EVENTO IGNORANDO CONFLITOS DA AGENDA.
		...
		//ALARMES E REPETI��O DE EVENTOS n�o S�O UTILIZADAS NA API
		$cal['uid']				= '';
		...
		//PARAMETRO SENDTOUI ADICIONADO AO BO.CALENDAR PARA EVITAR QUE O BO FA�A O REDIRECIONAMENTO PARA UM TEMPLATE.
		$params['sendToUi'] 		= '0';
