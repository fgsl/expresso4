...
ini_set("display_errors","1");
	...
	//david
	$tmpl->set_var('teste_compatibilidade',GlobalService::get('phpgw_info')['server']['teste_compatibilidade']);
	...
	if (count(GlobalService::get('phpgw_info')['server']['login_logo_file']) > 0) {
		$logo_config = GlobalService::get('phpgw_info')['server']['login_logo_file'];
