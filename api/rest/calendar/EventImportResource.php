...
class EventImportResource extends CatalogAdapter
{
	...
	public function setDocumentation() {
		...
		$this->setResource("VCALENDAR","/vcalendar/import/#","Recebe um hash e importa o compromisso na agenda. Substitua # por um hash v�lido gerado pelo Expresso.",array("GET"));
