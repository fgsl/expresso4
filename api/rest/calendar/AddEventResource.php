...
class AddEventResource extends CalendarAdapter {
	...
	public function setDocumentation() {
		...
		$this->setResource("Calendar","Calendar/AddEvent","Adiciona ou altera um evento na agenda do usuório.",array("POST"));
	...
	public function post($request){
		...
		if( $this->isLoggedIn() )
		{
			...
			//USADO PARA FORóAR A INCLUSóO DE UM EVENTO IGNORANDO CONFLITOS DA AGENDA.
			$eventIgnoreConflicts               = $this->getParam('eventIgnoreConflicts');

			$this->addModuleTranslation("calendar");

			//VALIDAçãES DE CAMPOS 
			...
			//ALARMES E REPETIçãO DE EVENTOS NóO SóO UTILIZADAS NA API
			$cal['uid']				= '';
